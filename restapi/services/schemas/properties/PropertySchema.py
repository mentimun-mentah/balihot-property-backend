...
class PropertySchema(Schema):
    ...
    land_size = fields.Float(required=True,validate=validate.Range(min=1,error="Value must be greater than 0"))
    youtube = fields.Str(validate=validate.Length(min=3,max=100))
    ...
    freehold_price = fields.Float(load_only=True,validate=validate.Range(min=1,error="Value must be greater than 0"))
    leasehold_price = fields.Float(load_only=True,validate=validate.Range(min=1,error="Value must be greater than 0"))
    ...
    daily_price = fields.Float(load_only=True,validate=validate.Range(min=1,error="Value must be greater than 0"))
    weekly_price = fields.Float(load_only=True,validate=validate.Range(min=1,error="Value must be greater than 0"))
    monthly_price = fields.Float(load_only=True,validate=validate.Range(min=1,error="Value must be greater than 0"))
    annually_price = fields.Float(load_only=True,validate=validate.Range(min=1,error="Value must be greater than 0"))
    # for villa
    ...
    building_size = fields.Float(validate=validate.Range(min=1,error="Value must be greater than 0"))
    # for map
